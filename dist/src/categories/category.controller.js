...
let CategoryController = class CategoryController {
    ...
    async getCategories() {
        try {
            ...
            throw new common_1.BadRequestException('Error getting categories');
        }
    }
    async preloadCategories() {
        try {
            ...
            throw new common_1.BadRequestException('Error preloading categories');
        }
    }
    async preloadCategoriesFromFile() {
        try {
            ...
            throw new common_1.BadRequestException('Error preloading categories from file');
        }
    }
};
